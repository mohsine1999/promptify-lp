...
const logos = ["Linear", "Raycast", "Gumroad", "Tally", "Bannerbear"];
...
export function Hero() {
  return (
    <section className="hero" id="top" aria-labelledby="hero-title">
          ...
          <FadeStagger>
            ...
            <FadeItem>
              <p className="hero__subtitle">
                Promptify pairs AI-assisted copy with proven layouts so indie makers, agencies, and PMs can launch
                faster—no pixel pushing, no creative debt.
              </p>
            </FadeItem>
            <FadeItem>
      ...
      <div className="hero__logos" aria-label="Teams shipping with Promptify">
        {logos.map((logo) => (
